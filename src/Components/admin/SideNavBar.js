    ...
    return (
        ...
        <div class="sidebar">
                ...
                <ul class="nav-links">
                    ...
                    <li>
                        <NavLink to='/admin-page/carts-admin' className={({ isActive }) => (isActive ? 'links_name' : 'links_name')}><i class='bx bx-list-ul'></i><span class="links_name">Carts list</span></NavLink>
                    </li>
                    <li>
