                            ...
                            {employees.map((employee, index) => {
                                return (
                                    <tr key={index + 1}>
                                        ...
                                        <td style={tableContent}> <a href={employee.profile_picture} target="_blank"><img className='image_profile_picture' src={employee.profile_picture} alt={employee.user.first_name} /></a> </td>
                                        ...
                                        <td style={tableContent}>{employee.birthdate}</td>
                                             ...
                                             <td style={tableContent}> <a href={employee.identification_card} target="_blank"><img className='image_profile_picture' src={employee.identification_card} alt={employee.user.first_name} /></a> </td>
